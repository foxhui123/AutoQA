...
import { Bot, Sparkles, LayoutList, Network, ArrowRight, Loader2, ClipboardList } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
      ...
      {/* Main Content */}
      <main className="flex-1 p-6 flex gap-6 overflow-hidden max-h-[calc(100vh-80px)]">
        {/* Left Panel: Input */}
             ...
             <div className="flex-1 flex flex-col h-full gap-4">
                {viewMode === 'map' ? (
                  <div className="flex-1 flex gap-4 h-full overflow-hidden">
                    ...
                    <div className={`w-80 bg-white border-l border-slate-200 shadow-xl fixed right-0 top-[80px] bottom-0 transform transition-transform duration-300 z-40 flex flex-col ${selectedScenario ? 'translate-x-0' : 'translate-x-full'}`}>
                        {selectedScenario && (
